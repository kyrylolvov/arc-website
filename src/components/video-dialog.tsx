  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <div className="group relative aspect-video cursor-pointer overflow-hidden rounded-lg border text-secondary-foreground/80">
      ...
      <DialogContent className="aspect-video max-w-[784px] overflow-hidden border-0 p-0">
