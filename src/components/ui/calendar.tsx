  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        nav_button_previous: "absolute left-1 rounded-full",
        nav_button_next: "absolute right-1 rounded-full",
      ...
      components={{
        IconLeft: ({ ...props }) => <ChevronLeft className="mr-[1px] h-4 w-4" />,
        IconRight: ({ ...props }) => <ChevronRight className="ml-[1px] h-4 w-4" />,
      }}
      {...props}
    />
  );
