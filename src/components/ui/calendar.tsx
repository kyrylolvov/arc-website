  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today:
          "text-foreground relative before:absolute  before:bottom-1.5 before:h-full before:w-[4px] before:h-[4px] before:rounded-full before:bg-primary before:content-['']",
